...
/**
        \brief Defines the traversability parameters, this will be used to compute the
   TRAVERSABILITY_COST
         */
...
void initCostTraversibily(sl::Terrain& cost_terrain, float resolution, float range,
                          float height_threshold);

void computeCost(sl::Terrain& elevation_terrain, sl::Terrain& cost_terrain,
...
namespace plane {
void compute_pca(std::vector<sl::float3>& points, sl::float3& normal_vect, sl::float3& centroid,
