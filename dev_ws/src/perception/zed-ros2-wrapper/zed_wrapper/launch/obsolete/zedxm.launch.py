...
def generate_launch_description():
    ...
    warning_1 = LogInfo(
        msg=" !!! WARNING !!! This launch file is obsolete and it will be removed in the next release."
    )
    warning_2 = LogInfo(
        msg=" Please use 'ros2 launch zed_wrapper zed_camera.launch.py camera_model:='zedxm' camera_name:='zed'' instead."
    )
    warning_3 = LogInfo(
        msg="============================================================================================================="
    )
