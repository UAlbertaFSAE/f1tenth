...
class ConfigTest(Node):
    """Test node for verifying detection_camera configuration parameters.

    This node declares and prints all configuration parameters used by the
    detection_camera module, and verifies that required model and classes files exist.
    """
    ...
    def __init__(self) -> None:
        ...
        print(
            f"detection_confidence: {self.get_parameter('detection_confidence').value}"
        )
        print("=" * 60 + "\n")
